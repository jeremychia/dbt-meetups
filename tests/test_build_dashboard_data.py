...
class BuildOutputTests(unittest.TestCase):
    ...
    def test_summary_totals_match_sum_of_chapters(self):
        ...
        chapters = self.output['chapters']
        self.assertEqual(s['total_events'], sum(c['total_events'] for c in chapters.values()))
        self.assertEqual(s['total_talks'], sum(c['total_talks'] for c in chapters.values()))
    ...
    def test_category_rollup_from_primary_topic(self):
        ...
        talk = next(t for t in self.output['all_talks'] if t['title'] == 'Testing your dbt models properly')
